...
AutoBones = CS.Trigger.AutoBones

BehaviourListener = CS.Trigger.BehaviourListener
FguiUtil = CS.Trigger.FguiUtil
Main = CS.Trigger.Main
XFolderTools = CS.Trigger.XFolderTools
XFileTools = CS.Trigger.XFileTools
Tools = CS.Trigger.Tools
ELuaEvent = CS.Trigger.ELuaEvent
FileEncoder = CS.Trigger.FileEncoder
